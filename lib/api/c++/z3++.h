...
namespace z3 {
	...
	inline void set_param(char const *param, int value) {
		std::ostringstream oss;
		oss << value;
		Z3_global_param_set(param, oss.str().c_str());
	}
...
#define Z3_THROW(x) {}
    ...
    */
	...
	public:
        ...
        */
		sort enumeration_sort(char const *name, unsigned n, char const *const *enum_names, func_decl_vector &cs,
		                      func_decl_vector &ts);
		...
		func_decl
		function(char const *name, sort const &d1, sort const &d2, sort const &d3, sort const &d4, sort const &range);

		func_decl
		function(char const *name, sort const &d1, sort const &d2, sort const &d3, sort const &d4, sort const &d5,
		         sort const &range);
	...
	public:
		...
		T &operator[](int i) {
			assert(0 <= i);
			assert(static_cast<unsigned>(i) < m_size);
			return m_array[i];
		}
	...
	public:
		...
		std::string str() const {
			assert(kind() == Z3_STRING_SYMBOL);
			return Z3_get_symbol_string(ctx(), m_sym);
		}

		int to_int() const {
			assert(kind() == Z3_INT_SYMBOL);
			return Z3_get_symbol_int(ctx(), m_sym);
		}
	...
	public:
		...
		param_descrs(param_descrs const &o) : object(o.ctx()), m_descrs(o.m_descrs) {
			Z3_param_descrs_inc_ref(ctx(), m_descrs);
		}
		...
		static param_descrs simplify_param_descrs(context &c) {
			return param_descrs(c, Z3_simplify_get_param_descrs(c));
		}
		...
		std::string documentation(symbol const &s) {
			char const *r = Z3_param_descrs_get_documentation(ctx(), m_descrs, s);
			check_error();
			return r;
		}
	...
	class params : public object {
		Z3_params m_params;
	public:
		params(context &c) : object(c) {
			m_params = Z3_mk_params(c);
	...
	inline std::ostream &operator<<(std::ostream &out, params const &p) {
		out << Z3_params_to_string(p.ctx(), p);
		return out;
	}
	...
	public:
		...
		Z3_ast_kind kind() const {
			Z3_ast_kind r = Z3_get_ast_kind(ctx(), m_ast);
			check_error();
			return r;
		}

		unsigned hash() const {
			unsigned r = Z3_get_ast_hash(ctx(), m_ast);
			check_error();
			return r;
		}
	...
	inline std::ostream &operator<<(std::ostream &out, ast const &n) {
		out << Z3_ast_to_string(n.ctx(), n.m_ast);
		return out;
	}
    ...
    */
	...
	public:
        ...
        */
		symbol name() const {
			Z3_symbol s = Z3_get_sort_name(ctx(), *this);
			check_error();
			return symbol(ctx(), s);
		}
        ...
        */
		unsigned bv_size() const {
			assert(is_bv());
			unsigned r = Z3_get_bv_sort_size(ctx(), *this);
			check_error();
			return r;
		}
        ...
        */
		sort array_domain() const {
			assert(is_array());
			Z3_sort s = Z3_get_array_sort_domain(ctx(), *this);
			check_error();
			return sort(ctx(), s);
		}
        ...
        */
		sort array_range() const {
			assert(is_array());
			Z3_sort s = Z3_get_array_sort_range(ctx(), *this);
			check_error();
			return sort(ctx(), s);
		}
	};
    ...
    */
	...
	public:
		...
		sort domain(unsigned i) const {
			assert(i < arity());
			Z3_sort r = Z3_get_domain(ctx(), *this, i);
			check_error();
			return sort(ctx(), r);
		}

		sort range() const {
			Z3_sort r = Z3_get_range(ctx(), *this);
			check_error();
			return sort(ctx(), r);
		}

		symbol name() const {
			Z3_symbol s = Z3_get_decl_name(ctx(), *this);
			check_error();
			return symbol(ctx(), s);
		}
    ...
    */
	...
	public:
        ...
        */
		sort get_sort() const {
			Z3_sort s = Z3_get_sort(*m_ctx, m_ast);
			check_error();
			return sort(*m_ctx, s);
		}
        ...
        */
		...
		bool is_numeral_i64(__int64 &i) const {
			bool r = 0 != Z3_get_numeral_int64(ctx(), m_ast, &i);
			check_error();
			return r;
		}

		bool is_numeral_u64(__uint64 &i) const {
			bool r = 0 != Z3_get_numeral_uint64(ctx(), m_ast, &i);
			check_error();
			return r;
		}

		bool is_numeral_i(int &i) const {
			bool r = 0 != Z3_get_numeral_int(ctx(), m_ast, &i);
			check_error();
			return r;
		}

		bool is_numeral_u(unsigned &i) const {
			bool r = 0 != Z3_get_numeral_uint(ctx(), m_ast, &i);
			check_error();
			return r;
		}

		bool is_numeral(std::string &s) const {
			if (!is_numeral()) return false;
			s = Z3_get_numeral_string(ctx(), m_ast);
			check_error();
			return true;
		}
		...
		bool is_numeral(std::string &s, unsigned precision) const {
			if (!is_numeral()) return false;
			s = Z3_get_numeral_decimal_string(ctx(), m_ast, precision);
			check_error();
			return true;
		}
        ...
        */
		bool is_well_sorted() const {
			bool r = Z3_is_well_sorted(ctx(), m_ast) != 0;
			check_error();
			return r;
		}
        ...
        */
		...
		operator Z3_app() const {
			assert(is_app());
			return reinterpret_cast<Z3_app>(m_ast);
		}
        ...
        */
		func_decl decl() const {
			Z3_func_decl f = Z3_get_app_decl(ctx(), *this);
			check_error();
			return func_decl(ctx(), f);
		}
        ...
        */
		unsigned num_args() const {
			unsigned r = Z3_get_app_num_args(ctx(), *this);
			check_error();
			return r;
		}
        ...
        */
		expr arg(unsigned i) const {
			Z3_ast r = Z3_get_app_arg(ctx(), *this, i);
			check_error();
			return expr(ctx(), r);
		}
        ...
        */
		expr body() const {
			...
			Z3_ast r = Z3_get_quantifier_body(ctx(), *this);
			check_error();
			return expr(ctx(), r);
		}
        ...
        */
		...
		expr extract(unsigned hi, unsigned lo) const {
			Z3_ast r = Z3_mk_extract(ctx(), hi, lo, *this);
			ctx().check_error();
			return expr(ctx(), r);
		}

		unsigned lo() const {
			assert (is_app() && Z3_get_decl_num_parameters(ctx(), decl()) == 2);
        ...
        */
		expr extract(expr const &offset, expr const &length) const {
			check_context(*this, offset);
			check_context(offset, length);
			Z3_ast r = Z3_mk_seq_extract(ctx(), *this, offset, length);
			check_error();
			return expr(ctx(), r);
		}
        ...
        */
		expr simplify() const {
			Z3_ast r = Z3_simplify(ctx(), m_ast);
			check_error();
			return expr(ctx(), r);
		}
        ...
        */
		expr simplify(params const &p) const {
			Z3_ast r = Z3_simplify_ex(ctx(), m_ast, p);
			check_error();
			return expr(ctx(), r);
		}
...
#undef _Z3_MK_UN_
	...
	inline expr operator==(expr const &a, int b) {
		assert(a.is_arith() || a.is_bv());
		return a == a.ctx().num_val(b, a.get_sort());
	}

	inline expr operator==(int a, expr const &b) {
		assert(b.is_arith() || b.is_bv());
    ...
    */
	...
	public:
		...
		ast_vector_tpl(ast_vector_tpl const &s) : object(s), m_vector(s.m_vector) {
			Z3_ast_vector_inc_ref(ctx(), m_vector);
		}
		...
		T operator[](int i) const {
			assert(0 <= i);
			Z3_ast r = Z3_ast_vector_get(ctx(), m_vector, i);
			check_error();
			return cast_ast<T>()(ctx(), r);
		}

		void push_back(T const &e) {
			Z3_ast_vector_push(ctx(), m_vector, e);
			check_error();
		}

		void resize(unsigned sz) {
			Z3_ast_vector_resize(ctx(), m_vector, sz);
			check_error();
		}
		...
		friend std::ostream &operator<<(std::ostream &out, ast_vector_tpl const &v) {
			out << Z3_ast_vector_to_string(v.ctx(), v);
			return out;
		}
	};
	...
	inline expr forall(expr const &x, expr const &b) {
		...
		Z3_ast r = Z3_mk_forall_const(b.ctx(), 0, 1, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr forall(expr const &x1, expr const &x2, expr const &b) {
		...
		Z3_ast r = Z3_mk_forall_const(b.ctx(), 0, 2, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr forall(expr const &x1, expr const &x2, expr const &x3, expr const &b) {
		...
		Z3_ast r = Z3_mk_forall_const(b.ctx(), 0, 3, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr forall(expr const &x1, expr const &x2, expr const &x3, expr const &x4, expr const &b) {
		...
		Z3_ast r = Z3_mk_forall_const(b.ctx(), 0, 4, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr forall(expr_vector const &xs, expr const &b) {
		...
		Z3_ast r = Z3_mk_forall_const(b.ctx(), 0, vars.size(), vars.ptr(), 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr exists(expr const &x, expr const &b) {
		check_context(x, b);
		Z3_app vars[] = {(Z3_app) x};
		Z3_ast r = Z3_mk_exists_const(b.ctx(), 0, 1, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr exists(expr const &x1, expr const &x2, expr const &b) {
		...
		check_context(x2, b);
		Z3_app vars[] = {(Z3_app) x1, (Z3_app) x2};
		Z3_ast r = Z3_mk_exists_const(b.ctx(), 0, 2, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr exists(expr const &x1, expr const &x2, expr const &x3, expr const &b) {
		...
		check_context(x3, b);
		Z3_app vars[] = {(Z3_app) x1, (Z3_app) x2, (Z3_app) x3};
		Z3_ast r = Z3_mk_exists_const(b.ctx(), 0, 3, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr exists(expr const &x1, expr const &x2, expr const &x3, expr const &x4, expr const &b) {
		...
		check_context(x4, b);
		Z3_app vars[] = {(Z3_app) x1, (Z3_app) x2, (Z3_app) x3, (Z3_app) x4};
		Z3_ast r = Z3_mk_exists_const(b.ctx(), 0, 4, vars, 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	inline expr exists(expr_vector const &xs, expr const &b) {
		array<Z3_app> vars(xs);
		Z3_ast r = Z3_mk_exists_const(b.ctx(), 0, vars.size(), vars.ptr(), 0, 0, b);
		b.check_error();
		return expr(b.ctx(), r);
	}
	...
	public:
		...
		expr value() const {
			Z3_ast r = Z3_func_entry_get_value(ctx(), m_entry);
			check_error();
			return expr(ctx(), r);
		}

		unsigned num_args() const {
			unsigned r = Z3_func_entry_get_num_args(ctx(), m_entry);
			check_error();
			return r;
		}

		expr arg(unsigned i) const {
			Z3_ast r = Z3_func_entry_get_arg(ctx(), m_entry, i);
			check_error();
			return expr(ctx(), r);
		}
	};
	...
	public:
		...
		expr else_value() const {
			Z3_ast r = Z3_func_interp_get_else(ctx(), m_interp);
			check_error();
			return expr(ctx(), r);
		}

		unsigned num_entries() const {
			unsigned r = Z3_func_interp_get_num_entries(ctx(), m_interp);
			check_error();
			return r;
		}

		func_entry entry(unsigned i) const {
			Z3_func_entry e = Z3_func_interp_get_entry(ctx(), m_interp, i);
			check_error();
	...
	public:
		...
		func_decl get_const_decl(unsigned i) const {
			Z3_func_decl r = Z3_model_get_const_decl(ctx(), m_model, i);
			check_error();
			return func_decl(ctx(), r);
		}

		func_decl get_func_decl(unsigned i) const {
			Z3_func_decl r = Z3_model_get_func_decl(ctx(), m_model, i);
			check_error();
			return func_decl(ctx(), r);
		}
	...
	inline std::ostream &operator<<(std::ostream &out, model const &m) {
		out << Z3_model_to_string(m.ctx(), m);
		return out;
	}
	...
	public:
		...
		std::string key(unsigned i) const {
			Z3_string s = Z3_stats_get_key(ctx(), m_stats, i);
			check_error();
			return s;
		}

		bool is_uint(unsigned i) const {
			Z3_bool r = Z3_stats_is_uint(ctx(), m_stats, i);
			check_error();
			return r != 0;
		}

		bool is_double(unsigned i) const {
			Z3_bool r = Z3_stats_is_double(ctx(), m_stats, i);
			check_error();
			return r != 0;
		}

		unsigned uint_value(unsigned i) const {
			unsigned r = Z3_stats_get_uint_value(ctx(), m_stats, i);
			check_error();
			return r;
		}

		double double_value(unsigned i) const {
			double r = Z3_stats_get_double_value(ctx(), m_stats, i);
			check_error();
			return r;
		}
	...
	inline std::ostream &operator<<(std::ostream &out, stats const &s) {
		out << Z3_stats_to_string(s.ctx(), s);
		return out;
	}
	...
	public:
		...
		void set(params const &p) {
			Z3_solver_set_params(ctx(), m_solver, p);
			check_error();
		}

		void push() {
			Z3_solver_push(ctx(), m_solver);
			check_error();
		}

		void pop(unsigned n = 1) {
			Z3_solver_pop(ctx(), m_solver, n);
			check_error();
		}

		void reset() {
			Z3_solver_reset(ctx(), m_solver);
			check_error();
		}

		void add(expr const &e) {
			assert(e.is_bool());
			Z3_solver_assert(ctx(), m_solver, e);
			check_error();
		}
		...
		check_result check() {
			Z3_lbool r = Z3_solver_check(ctx(), m_solver);
			check_error();
		...
		model get_model() const {
			Z3_model m = Z3_solver_get_model(ctx(), m_solver);
			check_error();
			return model(ctx(), m);
		}
		...
		std::string reason_unknown() const {
			Z3_string r = Z3_solver_get_reason_unknown(ctx(), m_solver);
			check_error();
			return r;
		}

		stats statistics() const {
			Z3_stats r = Z3_solver_get_statistics(ctx(), m_solver);
			check_error();
			return stats(ctx(), r);
		}

		expr_vector unsat_core() const {
			Z3_ast_vector r = Z3_solver_get_unsat_core(ctx(), m_solver);
			check_error();
			return expr_vector(ctx(), r);
		}

		expr_vector assertions() const {
			Z3_ast_vector r = Z3_solver_get_assertions(ctx(), m_solver);
			check_error();
			return expr_vector(ctx(), r);
		}

		expr proof() const {
			Z3_ast r = Z3_solver_get_proof(ctx(), m_solver);
			check_error();
			return expr(ctx(), r);
		}
	...
	inline std::ostream &operator<<(std::ostream &out, solver const &s) {
		out << Z3_solver_to_string(s.ctx(), s);
		return out;
	}
	...
	public:
		goal(context &c, bool models = true, bool unsat_cores = false, bool proofs = false) : object(c) {
		...
		expr operator[](int i) const {
			assert(0 <= i);
			Z3_ast r = Z3_goal_formula(ctx(), m_goal, i);
			check_error();
			return expr(ctx(), r);
		}
	...
	inline std::ostream &operator<<(std::ostream &out, goal const &g) {
		out << Z3_goal_to_string(g.ctx(), g);
		return out;
	}
	...
	public:
		...
		goal operator[](int i) const {
			assert(0 <= i);
			Z3_goal r = Z3_apply_result_get_subgoal(ctx(), m_apply_result, i);
			check_error();
			return goal(ctx(), r);
		}
	...
	inline std::ostream &operator<<(std::ostream &out, apply_result const &r) {
		out << Z3_apply_result_to_string(r.ctx(), r);
		return out;
	}
	...
	public:
		tactic(context &c, char const *name) : object(c) {
			Z3_tactic r = Z3_mk_tactic(c, name);
			check_error();
			init(r);
		}
		...
		solver mk_solver() const {
			Z3_solver r = Z3_mk_solver_from_tactic(ctx(), m_tactic);
			check_error();
			return solver(ctx(), r);
		}
		...
		std::string help() const {
			char const *r = Z3_tactic_get_help(ctx(), m_tactic);
			check_error();
			return r;
		}
	...
	public:
		probe(context &c, char const *name) : object(c) {
			Z3_probe r = Z3_mk_probe(c, name);
			check_error();
			init(r);
		}

		probe(context &c, double val) : object(c) {
		...
		double apply(goal const &g) const {
			double r = Z3_probe_apply(ctx(), m_probe, g);
			check_error();
			return r;
		}
	...
	inline probe operator<=(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_le(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}
	...
	inline probe operator>=(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_ge(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}
	...
	inline probe operator<(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_lt(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}
	...
	inline probe operator>(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_gt(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}
	...
	inline probe operator==(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_eq(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}
	...
	inline probe operator&&(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_and(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}
	...
	inline probe operator||(probe const &p1, probe const &p2) {
		check_context(p1, p2);
		Z3_probe r = Z3_probe_or(p1.ctx(), p1, p2);
		p1.check_error();
		return probe(p1.ctx(), r);
	}

	inline probe operator!(probe const &p) {
		Z3_probe r = Z3_probe_not(p.ctx(), p);
		p.check_error();
	...
	public:
		...
		check_result check() {
			Z3_lbool r = Z3_optimize_check(ctx(), m_opt);
			check_error();
			return to_check_result(r);
		}

		model get_model() const {
			Z3_model m = Z3_optimize_get_model(ctx(), m_opt);
			check_error();
			return model(ctx(), m);
		}

		void set(params const &p) {
			Z3_optimize_set_params(ctx(), m_opt, p);
			check_error();
		}
		...
		expr_vector assertions() const {
			Z3_ast_vector r = Z3_optimize_get_assertions(ctx(), m_opt);
			check_error();
			return expr_vector(ctx(), r);
		}

		expr_vector objectives() const {
			Z3_ast_vector r = Z3_optimize_get_objectives(ctx(), m_opt);
			check_error();
			return expr_vector(ctx(), r);
		}

		stats statistics() const {
			Z3_stats r = Z3_optimize_get_statistics(ctx(), m_opt);
			check_error();
			return stats(ctx(), r);
		}
		...
		void from_file(char const *filename) {
			Z3_optimize_from_file(ctx(), m_opt, filename);
			check_error();
		}

		void from_string(char const *constraints) {
			Z3_optimize_from_string(ctx(), m_opt, constraints);
			check_error();
		}

		std::string help() const {
			char const *r = Z3_optimize_get_help(ctx(), m_opt);
			check_error();
			return r;
		}
	};

	inline std::ostream &operator<<(std::ostream &out, optimize const &s) {
		out << Z3_optimize_to_string(s.ctx(), s.m_opt);
		return out;
	}
	...
	class fixedpoint : public object {
		Z3_fixedpoint m_fp;
	public:
		fixedpoint(context &c) : object(c) {
			m_fp = Z3_mk_fixedpoint(c);
			Z3_fixedpoint_inc_ref(c, m_fp);
		}
		...
		void from_file(char const *s) {
			Z3_fixedpoint_from_file(ctx(), m_fp, s);
			check_error();
		}

		void add_rule(expr &rule, symbol const &name) {
			Z3_fixedpoint_add_rule(ctx(), m_fp, rule, name);
			check_error();
		}

		void add_fact(func_decl &f, unsigned *args) {
			Z3_fixedpoint_add_fact(ctx(), m_fp, f, f.arity(), args);
			check_error();
		}

		check_result query(expr &q) {
			Z3_lbool r = Z3_fixedpoint_query(ctx(), m_fp, q);
			check_error();
			to_check_result(r);
		}
		...
		expr get_answer() {
			Z3_ast r = Z3_fixedpoint_get_answer(ctx(), m_fp);
			check_error();
			return expr(ctx(), r);
		}
		...
		void update_rule(expr &rule, symbol const &name) {
			Z3_fixedpoint_update_rule(ctx(), m_fp, rule, name);
			check_error();
		}

		unsigned get_num_levels(func_decl &p) {
			unsigned r = Z3_fixedpoint_get_num_levels(ctx(), m_fp, p);
			check_error();
			return r;
		}
		...
		void add_cover(int level, func_decl &p, expr &property) {
			Z3_fixedpoint_add_cover(ctx(), m_fp, level, p, property);
			check_error();
		}

		stats statistics() const {
			Z3_stats r = Z3_fixedpoint_get_statistics(ctx(), m_fp);
			check_error();
			return stats(ctx(), r);
		}
		...
		expr_vector assertions() const {
			Z3_ast_vector r = Z3_fixedpoint_get_assertions(ctx(), m_fp);
			check_error();
			return expr_vector(ctx(), r);
		}

		expr_vector rules() const {
			Z3_ast_vector r = Z3_fixedpoint_get_rules(ctx(), m_fp);
			check_error();
			return expr_vector(ctx(), r);
		}

		void set(params const &p) {
			Z3_fixedpoint_set_params(ctx(), m_fp, p);
			check_error();
		}
		...
		void push() {
			Z3_fixedpoint_push(ctx(), m_fp);
			check_error();
		}

		void pop() {
			Z3_fixedpoint_pop(ctx(), m_fp);
			check_error();
		}
	};

	inline std::ostream &operator<<(std::ostream &out, fixedpoint const &f) {
	...
	inline symbol context::str_symbol(char const *s) {
		Z3_symbol r = Z3_mk_string_symbol(m_ctx, s);
		check_error();
		return symbol(*this, r);
	}

	inline symbol context::int_symbol(int n) {
		Z3_symbol r = Z3_mk_int_symbol(m_ctx, n);
		check_error();
		return symbol(*this, r);
	}

	inline sort context::bool_sort() {
		Z3_sort s = Z3_mk_bool_sort(m_ctx);
		check_error();
		return sort(*this, s);
	}
	...
	inline sort context::real_sort() {
		Z3_sort s = Z3_mk_real_sort(m_ctx);
		check_error();
		return sort(*this, s);
	}

	inline sort context::bv_sort(unsigned sz) {
		Z3_sort s = Z3_mk_bv_sort(m_ctx, sz);
		check_error();
		return sort(*this, s);
	}

	inline sort context::string_sort() {
		Z3_sort s = Z3_mk_string_sort(m_ctx);
		check_error();
		return sort(*this, s);
	}

	inline sort context::seq_sort(sort &s) {
		Z3_sort r = Z3_mk_seq_sort(m_ctx, s);
		check_error();
		return sort(*this, r);
	}

	inline sort context::re_sort(sort &s) {
		Z3_sort r = Z3_mk_re_sort(m_ctx, s);
		check_error();
		return sort(*this, r);
	}

	inline sort context::array_sort(sort d, sort r) {
		Z3_sort s = Z3_mk_array_sort(m_ctx, d, r);
		check_error();
		return sort(*this, s);
	}

	inline sort
	context::enumeration_sort(char const *name, unsigned n, char const *const *enum_names, func_decl_vector &cs,
	                          func_decl_vector &ts) {
		...
		check_error();
		for (unsigned i = 0; i < n; i++) {
			cs.push_back(func_decl(*this, _cs[i]));
			ts.push_back(func_decl(*this, _ts[i]));
		}
		return s;
	}
	...
	inline func_decl
	context::function(char const *name, sort const &d1, sort const &d2, sort const &d3, sort const &range) {
		check_context(d1, range);
		check_context(d2, range);
	...
	inline func_decl context::function(char const *name, sort const &d1, sort const &d2, sort const &d3, sort const &d4,
	                                   sort const &range) {
		check_context(d1, range);
		check_context(d2, range);
		check_context(d3, range);
	...
	inline func_decl
	context::function(char const *name, sort const &d1, sort const &d2, sort const &d3, sort const &d4, sort const &d5,
	                  sort const &range) {
		check_context(d1, range);
		check_context(d2, range);
		check_context(d3, range);
	...
	inline expr context::int_val(int n) {
		Z3_ast r = Z3_mk_int(m_ctx, n, int_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::int_val(unsigned n) {
		Z3_ast r = Z3_mk_unsigned_int(m_ctx, n, int_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::int_val(__int64 n) {
		Z3_ast r = Z3_mk_int64(m_ctx, n, int_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::int_val(__uint64 n) {
		Z3_ast r = Z3_mk_unsigned_int64(m_ctx, n, int_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::int_val(char const *n) {
		Z3_ast r = Z3_mk_numeral(m_ctx, n, int_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::real_val(int n, int d) {
		Z3_ast r = Z3_mk_real(m_ctx, n, d);
		check_error();
		return expr(*this, r);
	}

	inline expr context::real_val(int n) {
		Z3_ast r = Z3_mk_int(m_ctx, n, real_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::real_val(unsigned n) {
		Z3_ast r = Z3_mk_unsigned_int(m_ctx, n, real_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::real_val(__int64 n) {
		Z3_ast r = Z3_mk_int64(m_ctx, n, real_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::real_val(__uint64 n) {
		Z3_ast r = Z3_mk_unsigned_int64(m_ctx, n, real_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::real_val(char const *n) {
		Z3_ast r = Z3_mk_numeral(m_ctx, n, real_sort());
		check_error();
		return expr(*this, r);
	}

	inline expr context::bv_val(int n, unsigned sz) {
		Z3_ast r = Z3_mk_int(m_ctx, n, bv_sort(sz));
		check_error();
		return expr(*this, r);
	}

	inline expr context::bv_val(unsigned n, unsigned sz) {
		Z3_ast r = Z3_mk_unsigned_int(m_ctx, n, bv_sort(sz));
		check_error();
		return expr(*this, r);
	}

	inline expr context::bv_val(__int64 n, unsigned sz) {
		Z3_ast r = Z3_mk_int64(m_ctx, n, bv_sort(sz));
		check_error();
		return expr(*this, r);
	}

	inline expr context::bv_val(__uint64 n, unsigned sz) {
		Z3_ast r = Z3_mk_unsigned_int64(m_ctx, n, bv_sort(sz));
		check_error();
		return expr(*this, r);
	}

	inline expr context::bv_val(char const *n, unsigned sz) {
		Z3_ast r = Z3_mk_numeral(m_ctx, n, bv_sort(sz));
		check_error();
		return expr(*this, r);
	}

	inline expr context::string_val(char const *s) {
		Z3_ast r = Z3_mk_string(m_ctx, s);
		check_error();
		return expr(*this, r);
	}

	inline expr context::string_val(std::string const &s) {
		Z3_ast r = Z3_mk_string(m_ctx, s.c_str());
		check_error();
		return expr(*this, r);
	}

	inline expr context::num_val(int n, sort const &s) {
		Z3_ast r = Z3_mk_int(m_ctx, n, s);
		check_error();
		return expr(*this, r);
	}
	...
	inline expr
	func_decl::operator()(expr const &a1, expr const &a2, expr const &a3, expr const &a4, expr const &a5) const {
		check_context(*this, a1);
		check_context(*this, a2);
		check_context(*this, a3);
		check_context(*this, a4);
		check_context(*this, a5);
	...
	inline expr to_real(expr const &a) {
		Z3_ast r = Z3_mk_int2real(a.ctx(), a);
		a.check_error();
		return expr(a.ctx(), r);
	}
	...
	inline expr store(expr const &a, int i, expr const &v) {
		return store(a, a.ctx().num_val(i, a.get_sort().array_domain()), v);
	}

	inline expr store(expr const &a, expr i, int v) {
		return store(a, i, a.ctx().num_val(v, a.get_sort().array_range()));
	}

	inline expr store(expr const &a, int i, int v) {
		return store(a, a.ctx().num_val(i, a.get_sort().array_domain()),
		             a.ctx().num_val(v, a.get_sort().array_range()));
	}
...
#define MK_EXPR2(_fn, _arg1, _arg2)             \
	...
	inline expr context::parse_string(char const *s, sort_vector const &sorts, func_decl_vector const &decls) {
		...
		Z3_ast r = Z3_parse_smtlib2_string(*this, s, sorts.size(), sort_names.ptr(), sorts1.ptr(), decls.size(),
		                                   decl_names.ptr(), decls1.ptr());
		check_error();
		return expr(*this, r);
	}
	...
	inline expr context::parse_file(char const *s, sort_vector const &sorts, func_decl_vector const &decls) {
		...
		Z3_ast r = Z3_parse_smtlib2_file(*this, s, sorts.size(), sort_names.ptr(), sorts1.ptr(), decls.size(),
		                                 decl_names.ptr(), decls1.ptr());
		check_error();
		return expr(*this, r);
	}
